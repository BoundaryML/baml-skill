...
- **Find thrown errors.** Run `baml describe root.fn --json` and read `shape`: it shows the effective inferred/transitive `throws` contract, while plain output may only show the written body.
